...
export const ptBR: TranslationResources = {
  ...
  workspace: {
    ...
    fileActions: {
      ...
      openInFileManagerFailed: "Não foi possível abrir no gerenciador de arquivos",
      copyPath: "Copiar caminho",
      download: "Baixar",
    ...
    git: {
      ...
      panel: {
        ...
        mergeChanges: "Alterações de mesclagem",
        commitMoreActions: "Mais ações de commit",
        commitStaged: "Fazer commit do conteúdo preparado",
        commitAll: "Fazer commit de todas as alterações",
        openChanges: "Abrir alterações",
        stageChange: "Preparar alterações",
        unstageChange: "Remover alterações da preparação",
        discardChange: "Descartar alterações",
        stageAllChanges: "Preparar todas as alterações",
        unstageAllChanges: "Remover todas as alterações da preparação",
        discardAllChanges: "Descartar todas as alterações",
        updateHostForScmOperations:
          "Atualize o host para usar as operações de controle de código-fonte.",
        changesMissing: "O host não retornou os detalhes dos arquivos alterados.",
        stageFailed: "Falha ao preparar alterações",
        unstageFailed: "Falha ao remover alterações da preparação",
        discardFailed: "Falha ao descartar alterações",
        discardConfirmTitle: "Descartar alterações?",
        discardConfirmFile:
          "Descartar todas as alterações em “{{path}}”? Esta ação não pode ser desfeita.",
        discardConfirmMany:
          "Descartar alterações em {{count}} arquivos? Esta ação não pode ser desfeita.",
        discardConfirmAction: "Descartar alterações",
        status: {
          added: "Adicionado",
          modified: "Modificado",
          deleted: "Excluído",
      ...
      diff: {
        ...
        commits: {
          ...
          filterAll: "Tudo",
          filterCount: "{{count}} itens",
          filterLabel: "Filtrar referências do Git",
          references: "Referências",
          locateHead: "Localizar commit atual",
          moreActions: "Mais ações do Git",
          expandFiles: "Expandir arquivos do commit",
          collapseFiles: "Recolher arquivos do commit",
          resize: "Redimensionar a altura do gráfico Git",
          updateHost: "Atualize o host para usar o novo gráfico do Git",
          filesChanged: "{{count}} arquivos alterados",
          insertions: "{{count}} inserções (+)",
          deletions: "{{count}} exclusões (-)",
          fetch: "Buscar",
          openFullDiff: "Abrir diff completo",
