  ...
  settings: {
    ...
    host: {
      ...
      codexProviderInjections: {
        ...
        advancedHint:
          "Set the Codex provider definition and environment variables for this session",
        ...
        definitionLabel: "Provider definition",
        definitionHint: "JSON object stored under this ID in Codex model_providers",
        envLabel: "Environment variables (optional)",
        envHint: "JSON string pairs injected only into this session runtime for env_key references",
