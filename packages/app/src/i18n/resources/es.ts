...
export const es: TranslationResources = {
  ...
  importSession: {
    ...
    empty: {
      noSearchMatches: "Ninguna sesión coincide con la búsqueda.",
  ...
  workspace: {
    ...
    git: {
      ...
      panel: {
        ...
        mergeChanges: "Cambios de fusión",
        commitMoreActions: "Más acciones de confirmación",
        commitStaged: "Confirmar preparados",
        commitAll: "Confirmar todos los cambios",
        openChanges: "Abrir cambios",
        stageChange: "Preparar cambios",
        unstageChange: "Quitar cambios del área de preparación",
        discardChange: "Descartar cambios",
        ...
        updateHostForScmOperations:
          "Actualiza el host para usar las operaciones de control de código fuente.",
        changesMissing: "El host no devolvió los detalles de los archivos modificados.",
        stageFailed: "No se pudieron preparar los cambios",
        unstageFailed: "No se pudieron quitar los cambios del área de preparación",
        discardFailed: "No se pudieron descartar los cambios",
        discardConfirmTitle: "¿Descartar cambios?",
        discardConfirmFile:
          "¿Descartar todos los cambios de «{{path}}»? Esta acción no se puede deshacer.",
        discardConfirmMany:
          "¿Descartar los cambios de {{count}} archivos? Esta acción no se puede deshacer.",
      ...
      diff: {
        ...
        commits: {
          title: "Gráfico",
          filterAuto: "Automático",
          filterAll: "Todo",
          filterCount: "{{count}} elementos",
          filterLabel: "Filtrar referencias de Git",
          references: "Referencias",
          locateHead: "Localizar el commit actual",
          moreActions: "Más acciones de Git",
          expandFiles: "Expandir archivos del commit",
          collapseFiles: "Contraer archivos del commit",
          resize: "Cambiar la altura del gráfico de Git",
          updateHost: "Actualiza el host para usar el nuevo gráfico de Git",
          filesChanged: "{{count}} archivos modificados",
          insertions: "{{count}} inserciones (+)",
          deletions: "{{count}} eliminaciones (-)",
          fetch: "Obtener",
          openFullDiff: "Abrir diferencia completa",
  ...
  sidebar: {
    ...
    workspace: {
      ...
      actions: {
        ...
        pin: "Anclar arriba",
        unpin: "Desanclar",
        pinGlobal: "Pin across all sessions",
        unpinGlobal: "Unpin from all sessions",
        pinProject: "Pin in this workspace only",
        unpinProject: "Unpin from this workspace",
        archive: "Archivo",
      ...
      codexProviderInjections: {
        keepCurrentModel: "Keep current session model",
        label: "Inject Codex provider",
        applying: "Applying {{name}}...",
        started: "Provider injected and Codex session started",
        reloaded: "Provider injected and Codex session reloaded",
        failed: "Failed to apply Codex provider injection",
        updateHost: "Update the host to use Codex provider injection.",
      },
      toasts: {
        workspacePathUnavailable: "RutaWorkspaceno disponible",
        sessionIdCopied: "ID de sesión copiado",
        copySessionIdFailed: "No se pudo copiar el ID de sesión",
  ...
  settings: {
    ...
    appearance: {
      ...
      spacing: {
        title: "Espaciado",
        conversationTitle: "Área de conversación",
        message: "Espaciado de mensajes",
        messageAccessibility: "Espaciado de mensajes de conversación en píxeles",
        paragraph: "Espaciado de párrafos",
        paragraphAccessibility: "Espaciado de párrafos de mensajes en píxeles",
        divider: "Espaciado de divisores",
        dividerAccessibility: "Espaciado vertical de divisores de conversación en píxeles",
        conversationVerticalPadding: "Margen vertical",
        conversationVerticalPaddingAccessibility:
          "Margen vertical del área de conversación en píxeles",
        conversationHorizontalPadding: "Margen horizontal",
        conversationHorizontalPaddingAccessibility:
          "Margen horizontal del área de conversación en píxeles",
        sidebarTitle: "Lista de espacios de trabajo",
        sidebarProject: "Espaciado de espacios de trabajo",
        sidebarProjectAccessibility: "Espaciado entre espacios de trabajo en píxeles",
        sidebarSession: "Espaciado de sesiones",
        sidebarSessionAccessibility: "Espaciado entre sesiones en píxeles",
        sidebarRowPadding: "Margen vertical de filas",
        sidebarRowPaddingAccessibility:
          "Margen vertical de las filas de espacios de trabajo y sesiones en píxeles",
        sidebarHorizontalPadding: "Margen horizontal de la lista",
        sidebarHorizontalPaddingAccessibility:
          "Margen horizontal de la lista de espacios de trabajo en píxeles",
      },
      fonts: {
        title: "Fuentes",
    ...
    host: {
      ...
      agentProfiles: {
        ...
        namePlaceholder: "Usa el nombre del modelo si se deja vacío",
        iconLabel: "Icono",
        noIcon: "Ninguno",
      ...
      codexProviderInjections: {
        title: "Codex provider injection",
        description:
          "Save switchable model providers for Codex sessions. The session menu selects a provider first, then one of its models.",
        configuredTitle: "Configured providers",
        unavailable: "Connect to this host to manage Codex provider injections",
        unsupported: "This host does not support Codex provider injection yet",
        empty: "No injections yet. Add one to switch providers from a Codex session menu.",
        add: "Add provider",
        addTitle: "Add Codex provider",
        editTitle: "Edit Codex provider",
        nameLabel: "Display name",
        namePlaceholder: "For example, Internal gateway",
        providerIdLabel: "model_provider ID",
        providerIdPlaceholder: "For example, internal_gateway",
        providerNameLabel: "Codex provider name",
        providerNameHint: "Uses the display name when left blank",
        baseUrlLabel: "API URL",
        modelsSection: "Available models",
        modelsHint: "These models appear after selecting this provider from the session menu",
        addModel: "Add model",
        removeModel: "Remove model {{index}}",
        modelPlaceholder: "For example, gpt-5.2-codex",
        modelAccessibilityLabel: "Model {{index}}",
        modelsRequired: "Add at least one model and make sure every model has a name",
        duplicateModel: "A provider cannot contain duplicate models",
        modelSummary: "{{count}} models · {{models}}",
        keepCurrentModelSummary: "No models configured; injection keeps the session model",
        credentialsSection: "Credentials and environment",
        credentialsHint: "These variables are passed only to Codex sessions using this provider",
        envKeyLabel: "API key variable (optional)",
        ...
        capabilitiesSection: "Connection capabilities",
        openAiAuthLabel: "OpenAI sign-in",
        openAiAuthHint: "Relay providers usually do not require it",
        websocketsLabel: "WebSocket",
        websocketsHint: "Match the provider's Codex WebSocket support",
        optionDefault: "Default",
        optionEnabled: "Enabled",
        optionDisabled: "Disabled",
        additionalDefinitionLabel: "Other provider fields",
        additionalDefinitionHint: "Add JSON only for extra model_providers fields",
        required: "Display name and model_provider ID are required",
        saving: "Saving...",
        reorder: "Drag to reorder",
        removeConfirmTitle: "Remove provider injection?",
        removeConfirmMessage:
          'Remove "{{name}}"? Sessions using it will fail clearly on their next start until another injection is selected.',
      },
      daemon: {
        rename: {
