  ...
  settings: {
    ...
    host: {
      ...
      codexProviderInjections: {
        ...
        advancedHint: "填写 Codex 服务商定义和仅对该会话生效的环境变量",
        definitionLabel: "服务商定义",
        definitionHint: "Codex model_providers 中该标识对应的 JSON 对象",
        envLabel: "环境变量（可选）",
        envHint: "仅注入此会话运行时的 JSON 字符串键值对，可供 env_key 引用",
