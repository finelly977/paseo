...
export const zhCN: TranslationResources = {
  ...
  workspace: {
    ...
    git: {
      ...
      panel: {
        ...
        publishBranch: "发布分支",
        mergeChanges: "合并更改",
        commitMoreActions: "更多提交操作",
        commitStaged: "提交暂存区",
        commitAll: "提交全部更改",
        openChanges: "打开更改",
        stageChange: "暂存更改",
        unstageChange: "取消暂存更改",
        discardChange: "放弃更改",
        stageAllChanges: "暂存所有更改",
        unstageAllChanges: "取消暂存所有更改",
        discardAllChanges: "放弃所有更改",
        updateHostForScmOperations: "请更新主机后使用源代码管理操作。",
        changesMissing: "主机未返回源代码管理文件明细。",
        stageFailed: "暂存更改失败",
        unstageFailed: "取消暂存更改失败",
        discardFailed: "放弃更改失败",
        discardConfirmTitle: "要放弃更改吗？",
        discardConfirmFile: "要放弃“{{path}}”中的所有更改吗？此操作无法撤销。",
        discardConfirmMany: "要放弃 {{count}} 个文件中的更改吗？此操作无法撤销。",
        discardConfirmAction: "放弃更改",
        status: {
          added: "已添加",
          modified: "已修改",
          deleted: "已删除",
      ...
      diff: {
        ...
        commits: {
          ...
          filterAll: "全部",
          filterCount: "{{count}} 项",
          filterLabel: "筛选 Git 引用",
          references: "引用",
          locateHead: "定位当前提交",
          moreActions: "更多 Git 操作",
          expandFiles: "展开提交文件",
          collapseFiles: "收起提交文件",
          resize: "调整 Git 图表高度",
          updateHost: "请更新主机后使用新版 Git 图表",
          filesChanged: "变更了 {{count}} 个文件",
          insertions: "新增 {{count}} 行 (+)",
  ...
  sidebar: {
    ...
    workspace: {
      ...
      actions: {
        ...
        unpin: "取消置顶",
        pinGlobal: "置顶到所有会话",
        unpinGlobal: "取消所有会话置顶",
        pinProject: "仅在当前工作区置顶",
        unpinProject: "取消工作区内置顶",
        archive: "归档",
      ...
      codexProviderInjections: {
        label: "注入 Codex 服务商",
        keepCurrentModel: "保留当前会话模型",
        applying: "正在应用 {{name}}...",
        started: "已注入服务商并启动 Codex 会话",
        reloaded: "已注入服务商并重新加载 Codex 会话",
        failed: "应用 Codex 服务商注入失败",
        updateHost: "请更新主机后再使用 Codex 服务商注入。",
      },
      toasts: {
  ...
  settings: {
    ...
    hostSections: {
      connections: "连接",
      agents: "Agents",
      codexProviders: "Codex 服务商",
      workspaces: "Workspaces",
      providers: "Providers",
      usage: "使用情况",
      terminals: "Terminals",
      plugins: pluginSettings["zh-CN"].title,
      host: "概览",
    },
    ...
    appearance: {
      ...
      spacing: {
        title: "间距",
        conversationTitle: "对话区域",
        message: "消息间距",
        messageAccessibility: "对话消息间距（像素）",
        paragraph: "段落间距",
        paragraphAccessibility: "消息段落间距（像素）",
        divider: "分割线间距",
        dividerAccessibility: "对话分割线上下间距（像素）",
        conversationVerticalPadding: "区域上下边距",
        conversationVerticalPaddingAccessibility: "对话区域上下边距（像素）",
        conversationHorizontalPadding: "区域左右边距",
        conversationHorizontalPaddingAccessibility: "对话区域左右边距（像素）",
        sidebarTitle: "工作区列表",
        sidebarProject: "工作区间距",
        sidebarProjectAccessibility: "工作区之间的间距（像素）",
        sidebarSession: "会话间距",
        sidebarSessionAccessibility: "会话之间的间距（像素）",
        sidebarRowPadding: "行内上下留白",
        sidebarRowPaddingAccessibility: "工作区和会话行内上下留白（像素）",
        sidebarHorizontalPadding: "列表左右边距",
        sidebarHorizontalPaddingAccessibility: "工作区列表左右边距（像素）",
      },
      fonts: {
        title: "字体",
        systemDefault: "系统默认",
    ...
    host: {
      ...
      codexProviderInjections: {
        title: "Codex 服务商注入",
        description:
          "为 Codex 会话保存可切换的模型服务商。会话菜单会先选择服务商，再选择该服务商下的模型。",
        configuredTitle: "已配置服务商",
        unavailable: "连接到这个 Host 以管理 Codex 服务商注入配置",
        unsupported: "此 Host 运行的 Daemon 尚不支持 Codex 服务商注入",
        empty: "还没有注入配置。添加后可从 Codex 会话菜单切换模型服务商。",
        add: "添加服务商",
        addTitle: "添加 Codex 服务商",
        editTitle: "编辑 Codex 服务商",
        nameLabel: "显示名称",
        namePlaceholder: "例如 内部中转",
        providerIdLabel: "model_provider 标识",
        providerIdPlaceholder: "例如 internal_gateway",
        providerNameLabel: "Codex 服务商名称",
        providerNameHint: "留空时使用显示名称",
        baseUrlLabel: "API 地址",
        modelsSection: "可用模型",
        modelsHint: "会话菜单会在选定服务商后列出这些模型",
        addModel: "添加模型",
        removeModel: "移除模型 {{index}}",
        modelPlaceholder: "例如 gpt-5.2-codex",
        modelAccessibilityLabel: "模型 {{index}}",
        modelsRequired: "请至少填写一个模型，且模型名称不能为空",
        duplicateModel: "同一服务商下不能配置重复模型",
        modelSummary: "{{count}} 个模型 · {{models}}",
        keepCurrentModelSummary: "未配置模型，注入时保留会话当前模型",
        credentialsSection: "凭据与环境变量",
        credentialsHint: "这些变量只传给使用该配置启动的 Codex 会话",
        envKeyLabel: "API 密钥变量名（可选）",
        envNamePlaceholder: "变量名",
        envValuePlaceholder: "值",
        addEnvironmentVariable: "添加环境变量",
        removeEnvironmentVariable: "移除环境变量",
        capabilitiesSection: "连接能力",
        openAiAuthLabel: "OpenAI 登录",
        openAiAuthHint: "中转服务通常选择“不需要”",
        websocketsLabel: "WebSocket",
        websocketsHint: "按服务商是否支持 Codex WebSocket 连接设置",
        optionDefault: "默认",
        optionEnabled: "启用",
        optionDisabled: "禁用",
        additionalDefinitionLabel: "其他服务商参数",
        additionalDefinitionHint: "仅在需要额外的 model_providers 字段时填写 JSON",
        required: "显示名称和 model_provider 标识必填",
        saving: "保存中...",
        reorder: "拖动调整顺序",
        removeConfirmTitle: "移除服务商注入？",
        removeConfirmMessage:
          "移除「{{name}}」？已使用它的会话下次启动时会明确报错，直到选择其他配置。",
      },
      daemon: {
        rename: {
          editLabel: "编辑标签",
