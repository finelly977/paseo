  ...
  workspace: {
    ...
    git: {
      ...
      panel: {
        ...
        mergeChanges: "Изменения слияния",
        commitMoreActions: "Другие действия с коммитом",
        commitStaged: "Закоммитить индексированные изменения",
        commitAll: "Закоммитить все изменения",
        openChanges: "Открыть изменения",
        stageChange: "Добавить изменения в индекс",
        unstageChange: "Убрать изменения из индекса",
        discardChange: "Отменить изменения",
        stageAllChanges: "Добавить все изменения в индекс",
        unstageAllChanges: "Убрать все изменения из индекса",
        discardAllChanges: "Отменить все изменения",
        updateHostForScmOperations:
          "Обновите хост, чтобы использовать операции управления исходным кодом.",
        changesMissing: "Хост не вернул сведения об изменённых файлах.",
        stageFailed: "Не удалось добавить изменения в индекс",
        unstageFailed: "Не удалось убрать изменения из индекса",
        discardFailed: "Не удалось отменить изменения",
        discardConfirmTitle: "Отменить изменения?",
        discardConfirmFile: "Отменить все изменения в «{{path}}»? Это действие нельзя отменить.",
        discardConfirmMany: "Отменить изменения в {{count}} файлах? Это действие нельзя отменить.",
        discardConfirmAction: "Отменить изменения",
        status: {
          added: "Добавлен",
          modified: "Изменён",
          deleted: "Удалён",
      ...
      diff: {
        ...
        deletedFile: "Удалено",
        commits: {
          filterAuto: "Автоматически",
          filterAll: "Все",
          filterCount: "Элементов: {{count}}",
          filterLabel: "Фильтр ссылок Git",
          references: "Ссылки",
          locateHead: "Найти текущий коммит",
          moreActions: "Другие действия Git",
          expandFiles: "Развернуть файлы коммита",
          collapseFiles: "Свернуть файлы коммита",
          resize: "Изменить высоту графа Git",
          updateHost: "Обновите хост, чтобы использовать новый граф Git",
          filesChanged: "Изменено файлов: {{count}}",
          insertions: "Добавлено строк: {{count}} (+)",
          deletions: "Удалено строк: {{count}} (-)",
          fetch: "Получить",
          openFullDiff: "Открыть полный diff",
