...
export const ja: TranslationResources = {
  ...
  workspace: {
    ...
    git: {
      ...
      panel: {
        ...
        mergeChanges: "マージの変更",
        commitMoreActions: "その他のコミット操作",
        commitStaged: "ステージ済みをコミット",
        commitAll: "すべての変更をコミット",
        openChanges: "変更を開く",
        stageChange: "変更をステージ",
        unstageChange: "変更のステージを解除",
        discardChange: "変更を破棄",
        stageAllChanges: "すべての変更をステージ",
        unstageAllChanges: "すべての変更のステージを解除",
        discardAllChanges: "すべての変更を破棄",
        updateHostForScmOperations: "ソース管理操作を使用するにはホストを更新してください。",
        changesMissing: "ホストから変更ファイルの詳細が返されませんでした。",
        stageFailed: "変更のステージに失敗しました",
        unstageFailed: "変更のステージ解除に失敗しました",
        discardFailed: "変更の破棄に失敗しました",
        discardConfirmTitle: "変更を破棄しますか？",
        discardConfirmFile: "「{{path}}」のすべての変更を破棄しますか？この操作は元に戻せません。",
        discardConfirmMany:
          "{{count}} 個のファイルの変更を破棄しますか？この操作は元に戻せません。",
        discardConfirmAction: "変更を破棄",
        status: {
          added: "追加済み",
          modified: "変更済み",
          deleted: "削除済み",
      ...
      diff: {
        ...
        commits: {
          ...
          filterAll: "すべて",
          filterCount: "{{count}} 件",
          filterLabel: "Git 参照を絞り込む",
          references: "参照",
          locateHead: "現在のコミットを表示",
          moreActions: "その他の Git 操作",
          expandFiles: "コミットのファイルを展開",
          collapseFiles: "コミットのファイルを折りたたむ",
          resize: "Git グラフの高さを変更",
          updateHost: "新しい Git グラフを使用するにはホストを更新してください",
          filesChanged: "{{count}} 個のファイルを変更",
          insertions: "{{count}} 行追加 (+)",
          deletions: "{{count}} 行削除 (-)",
          fetch: "取得",
  ...
  sidebar: {
    ...
    workspace: {
      ...
      toasts: {
        ...
        copySessionIdFailed: "セッション ID のコピーに失敗しました",
  ...
  settings: {
    ...
    appearance: {
      ...
      spacing: {
        title: "間隔",
        conversationTitle: "会話エリア",
        message: "メッセージ間隔",
        messageAccessibility: "会話メッセージの間隔（ピクセル）",
        paragraph: "段落の間隔",
        paragraphAccessibility: "メッセージ段落の間隔（ピクセル）",
        divider: "区切り線の間隔",
        dividerAccessibility: "会話区切り線の上下間隔（ピクセル）",
        conversationVerticalPadding: "上下の余白",
        conversationVerticalPaddingAccessibility: "会話エリアの上下余白（ピクセル）",
        conversationHorizontalPadding: "左右の余白",
        conversationHorizontalPaddingAccessibility: "会話エリアの左右余白（ピクセル）",
        sidebarTitle: "ワークスペース一覧",
        sidebarProject: "ワークスペース間隔",
        sidebarProjectAccessibility: "ワークスペース間の間隔（ピクセル）",
        sidebarSession: "セッション間隔",
        sidebarSessionAccessibility: "セッション間の間隔（ピクセル）",
        sidebarRowPadding: "行の上下余白",
        sidebarRowPaddingAccessibility: "ワークスペースとセッション行の上下余白（ピクセル）",
        sidebarHorizontalPadding: "一覧の左右余白",
        sidebarHorizontalPaddingAccessibility: "ワークスペース一覧の左右余白（ピクセル）",
      },
      fonts: {
        title: "フォント",
