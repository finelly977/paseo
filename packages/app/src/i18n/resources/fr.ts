...
export const fr: TranslationResources = {
  ...
  workspace: {
    ...
    fileActions: {
      ...
      openInFileManagerFailed: "Impossible d’ouvrir dans le gestionnaire de fichiers",
      copyPath: "Copier le chemin",
    ...
    git: {
      ...
      panel: {
        ...
        mergeChanges: "Modifications de fusion",
        commitMoreActions: "Autres actions de validation",
        commitStaged: "Valider les changements indexés",
        commitAll: "Valider toutes les modifications",
        openChanges: "Ouvrir les modifications",
        stageChange: "Indexer les modifications",
        unstageChange: "Désindexer les modifications",
        discardChange: "Abandonner les modifications",
        ...
        updateHostForScmOperations:
          "Mettez à jour l’hôte pour utiliser les opérations de gestion de code source.",
        changesMissing: "L’hôte n’a pas renvoyé le détail des fichiers modifiés.",
        stageFailed: "Échec de l’indexation des modifications",
        unstageFailed: "Échec de la désindexation des modifications",
        discardFailed: "Échec de l’abandon des modifications",
        discardConfirmTitle: "Abandonner les modifications ?",
        discardConfirmFile:
          "Abandonner toutes les modifications de « {{path}} » ? Cette action est irréversible.",
        discardConfirmMany:
          "Abandonner les modifications de {{count}} fichiers ? Cette action est irréversible.",
        discardConfirmAction: "Abandonner les modifications",
        status: {
          added: "Ajouté",
          modified: "Modifié",
          deleted: "Supprimé",
      ...
      diff: {
        ...
        commits: {
          filterAuto: "Automatique",
          filterAll: "Tout",
          filterCount: "{{count}} éléments",
          filterLabel: "Filtrer les références Git",
          references: "Références",
          locateHead: "Localiser le commit actuel",
          moreActions: "Autres actions Git",
          expandFiles: "Développer les fichiers du commit",
          collapseFiles: "Réduire les fichiers du commit",
          resize: "Redimensionner la hauteur du graphe Git",
          updateHost: "Mettez à jour l’hôte pour utiliser le nouveau graphe Git",
          filesChanged: "{{count}} fichiers modifiés",
          insertions: "{{count}} insertions (+)",
          deletions: "{{count}} suppressions (-)",
          fetch: "Récupérer",
          openFullDiff: "Ouvrir le diff complet",
