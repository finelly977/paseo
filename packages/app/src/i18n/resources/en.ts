...
export const en = {
  ...
  workspace: {
    ...
    git: {
      ...
      panel: {
        ...
        commitMoreActions: "More commit actions",
        commitStaged: "Commit Staged",
        commitAll: "Commit All Changes",
        openChanges: "Open Changes",
        stageChange: "Stage Changes",
        unstageChange: "Unstage Changes",
        ...
        updateHostForScmOperations: "Update the host to use source control operations.",
        changesMissing: "The host did not return source control file details.",
        ...
        discardConfirmFile: 'Discard all changes in "{{path}}"? This cannot be undone.',
      ...
      diff: {
        ...
        commits: {
          ...
          filterLabel: "Filter Git references",
          references: "References",
          locateHead: "Locate current commit",
          moreActions: "More Git actions",
          expandFiles: "Expand commit files",
          collapseFiles: "Collapse commit files",
          resize: "Resize Git graph height",
          updateHost: "Update the host to use the new Git graph",
  ...
  settings: {
    ...
    appearance: {
      ...
      spacing: {
        title: "Spacing",
        conversationTitle: "Conversation area",
        message: "Message spacing",
        messageAccessibility: "Conversation message spacing in pixels",
        paragraph: "Paragraph spacing",
        paragraphAccessibility: "Message paragraph spacing in pixels",
        divider: "Divider spacing",
        dividerAccessibility: "Conversation divider vertical spacing in pixels",
        conversationVerticalPadding: "Vertical padding",
        conversationVerticalPaddingAccessibility: "Conversation area vertical padding in pixels",
        conversationHorizontalPadding: "Horizontal padding",
        conversationHorizontalPaddingAccessibility:
          "Conversation area horizontal padding in pixels",
        sidebarTitle: "Workspace list",
        sidebarProject: "Workspace spacing",
        sidebarProjectAccessibility: "Spacing between workspaces in pixels",
        sidebarSession: "Session spacing",
        sidebarSessionAccessibility: "Spacing between sessions in pixels",
        sidebarRowPadding: "Row vertical padding",
        sidebarRowPaddingAccessibility: "Workspace and session row vertical padding in pixels",
        sidebarHorizontalPadding: "List horizontal padding",
        sidebarHorizontalPaddingAccessibility: "Workspace list horizontal padding in pixels",
      },
      fonts: {
        title: "Fonts",
