...
export const ar: TranslationResources = {
  ...
  workspace: {
    ...
    git: {
      ...
      panel: {
        ...
        mergeChanges: "تغييرات الدمج",
        commitMoreActions: "المزيد من إجراءات الالتزام",
        commitStaged: "تثبيت التغييرات المرحّلة",
        commitAll: "تثبيت جميع التغييرات",
        openChanges: "فتح التغييرات",
        stageChange: "ترحيل التغييرات",
        unstageChange: "إلغاء ترحيل التغييرات",
        discardChange: "تجاهل التغييرات",
        stageAllChanges: "ترحيل جميع التغييرات",
        unstageAllChanges: "إلغاء ترحيل جميع التغييرات",
        discardAllChanges: "تجاهل جميع التغييرات",
        updateHostForScmOperations: "حدّث المضيف لاستخدام عمليات التحكم في المصدر.",
        changesMissing: "لم يُرجع المضيف تفاصيل الملفات المتغيرة.",
        stageFailed: "تعذّر ترحيل التغييرات",
        unstageFailed: "تعذّر إلغاء ترحيل التغييرات",
        discardFailed: "تعذّر تجاهل التغييرات",
        discardConfirmTitle: "هل تريد تجاهل التغييرات؟",
        discardConfirmFile:
          "هل تريد تجاهل جميع التغييرات في «{{path}}»؟ لا يمكن التراجع عن هذا الإجراء.",
        discardConfirmMany:
          "هل تريد تجاهل التغييرات في {{count}} ملفات؟ لا يمكن التراجع عن هذا الإجراء.",
        discardConfirmAction: "تجاهل التغييرات",
        status: {
          added: "مضاف",
          modified: "معدّل",
          deleted: "محذوف",
      ...
      diff: {
        ...
        commits: {
          ...
          filterAuto: "تلقائي",
          filterAll: "الكل",
          filterCount: "{{count}} عناصر",
          filterLabel: "تصفية مراجع Git",
          references: "المراجع",
          locateHead: "تحديد الالتزام الحالي",
          moreActions: "المزيد من إجراءات Git",
          expandFiles: "توسيع ملفات الالتزام",
          collapseFiles: "طي ملفات الالتزام",
          resize: "تغيير ارتفاع مخطط Git",
          updateHost: "حدّث المضيف لاستخدام مخطط Git الجديد",
          filesChanged: "تم تغيير {{count}} من الملفات",
          insertions: "{{count}} إضافة (+)",
          deletions: "{{count}} حذف (-)",
          fetch: "جلب",
          openFullDiff: "فتح الفرق الكامل",
  ...
  settings: {
    ...
    appearance: {
      ...
      spacing: {
        title: "التباعد",
        conversationTitle: "منطقة المحادثة",
        message: "تباعد الرسائل",
        messageAccessibility: "تباعد رسائل المحادثة بالبكسل",
        paragraph: "تباعد الفقرات",
        paragraphAccessibility: "تباعد فقرات الرسالة بالبكسل",
        divider: "تباعد الفواصل",
        dividerAccessibility: "التباعد الرأسي لفواصل المحادثة بالبكسل",
        conversationVerticalPadding: "الهامش الرأسي",
        conversationVerticalPaddingAccessibility: "الهامش الرأسي لمنطقة المحادثة بالبكسل",
        conversationHorizontalPadding: "الهامش الأفقي",
        conversationHorizontalPaddingAccessibility: "الهامش الأفقي لمنطقة المحادثة بالبكسل",
        sidebarTitle: "قائمة مساحات العمل",
        sidebarProject: "تباعد مساحات العمل",
        sidebarProjectAccessibility: "التباعد بين مساحات العمل بالبكسل",
        sidebarSession: "تباعد الجلسات",
        sidebarSessionAccessibility: "التباعد بين الجلسات بالبكسل",
        sidebarRowPadding: "الهامش الرأسي للصفوف",
        sidebarRowPaddingAccessibility: "الهامش الرأسي لصفوف مساحات العمل والجلسات بالبكسل",
        sidebarHorizontalPadding: "الهامش الأفقي للقائمة",
        sidebarHorizontalPaddingAccessibility: "الهامش الأفقي لقائمة مساحات العمل بالبكسل",
      },
      fonts: {
        title: "الخطوط",
